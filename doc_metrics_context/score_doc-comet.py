...
def main(args):
    ...
    for sysname, cand in evs.sys_outputs.items():
        ...
        if args.doc:
            ...
            src = add_context(orig_txt=source, context=ctxt_src, doc_ids=doc_ids, sep_token=model.encoder.tokenizer.sep_token)
